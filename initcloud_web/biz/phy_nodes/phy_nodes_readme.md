...
1.各个文件的说明
   ...
   phy_nodes_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。
...
3.部署应用
   ...
   j.add app in settings
      ...
      比如应用的名称是phy_nodes,则添加biz.phy_nodes
