...
1.各个文件的说明
   ...
   cloud_monitor_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   cloud_monitor.html: 具体模版 
...
3.部署应用
   ...
   d.添加sidebar
        ...
        比如:
         ...
         <li>
            <a href="#/cloud_monitor/">
                <i class="fa fa-users"></i>
                <span class="title">
                    {[{ 'sidebar.cloud_monitor' | i18next }]}
                </span>
   ...
   j.add app in settings
      ...
      比如应用的名称是cloud_monitor,则添加biz.cloud_monitor
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh cloud_monitor 
