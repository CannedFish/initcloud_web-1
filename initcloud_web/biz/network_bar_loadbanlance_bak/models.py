...
class Network_Bar_Loadbanlance(models.Model):
    #user = models.ForeignKey(User)
    #udc = models.ForeignKey('idc.UserDataCenter')

    network_bar_loadbanlancename = models.CharField(_("Role"), max_length=15, null=False)
    ...
    def log(cls, obj, obj_name, action, result=1, udc=None, user=None):
        ...
        try:
            Network_Bar_Loadbanlance.objects.create(
