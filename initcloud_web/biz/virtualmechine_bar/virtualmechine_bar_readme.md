...
1.各个文件的说明
   ...
   virtualmechine_bar_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   virtualmechine_bar.html: 具体模版 
...
3.部署应用
   ...
   d.添加sidebar
        ...
        比如:
         ...
         <li>
            <a href="#/virtualmechine_bar/">
                <i class="fa fa-users"></i>
                <span class="title">
                    {[{ 'sidebar.virtualmechine_bar' | i18next }]}
                </span>
   ...
   g.拷贝virtualmechine_bar_ctrl.js 文件拷贝至如下目录：	

      /var/www/initcloud_web/initcloud_web/render/static/management/controllers/

   h. 拷贝virtualmechine_bar.html 文件拷贝至如下目录：
   ...
   j.add app in settings
      ...
      比如应用的名称是virtualmechine_bar,则添加biz.virtualmechine_bar
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh virtualmechine_bar 
