...
1.各个文件的说明
   ...
   wuli_storage_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   wuli_storage.html: 具体模版 
...
3.部署应用
   ...
   j.add app in settings
      ...
      比如应用的名称是wuli_storage,则添加biz.wuli_storage
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh wuli_storage 
