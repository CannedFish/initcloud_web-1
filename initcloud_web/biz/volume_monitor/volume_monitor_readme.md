...
1.各个文件的说明
   ...
   volume_monitor_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   volume_monitor.html: 具体模版 
...
3.部署应用
   ...
   d.添加sidebar
        ...
        比如:
         ...
         <li>
            <a href="#/volume_monitor/">
                <i class="fa fa-users"></i>
                <span class="title">
                    {[{ 'sidebar.volume_monitor' | i18next }]}
                </span>
   ...
   j.add app in settings
      ...
      比如应用的名称是volume_monitor,则添加biz.volume_monitor
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh volume_monitor 
