...
1.各个文件的说明
   ...
   memory_monitor_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   memory_monitor.html: 具体模版 
...
3.部署应用
        ...
        比如:
         ...
         <li>
            <a href="#/memory_monitor/">
                ...
                <span class="title">
                    {[{ 'sidebar.memory_monitor' | i18next }]}
                </span>
   ...
   j.add app in settings
      ...
      比如应用的名称是memory_monitor,则添加biz.memory_monitor
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh memory_monitor 
