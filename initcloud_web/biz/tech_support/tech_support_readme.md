...
1.各个文件的说明
   ...
   tech_support_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   tech_support.html: 具体模版 
...
3.部署应用
   ...
   j.add app in settings
      ...
      比如应用的名称是tech_support,则添加biz.tech_support
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh tech_support 
