...
1.各个文件的说明
   ...
   network_bar_sdn_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   network_bar_sdn.html: 具体模版 
...
3.部署应用
   ...
   d.添加sidebar
        ...
        比如:
         ...
         <li>
            <a href="#/network_bar_sdn/">
                <i class="fa fa-users"></i>
                <span class="title">
                    {[{ 'sidebar.network_bar_sdn' | i18next }]}
                </span>
   ...
   j.add app in settings
      ...
      比如应用的名称是network_bar_sdn,则添加biz.network_bar_sdn
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh network_bar_sdn 
