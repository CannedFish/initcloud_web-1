...
1.各个文件的说明
   ...
   warning_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。
...
3.部署应用
   ...
   j.add app in settings
      ...
      比如应用的名称是warning,则添加biz.warning
