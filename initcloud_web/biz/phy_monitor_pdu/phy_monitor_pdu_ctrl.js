...
CloudApp.controller('Phy_Monitor_PduController',
    function($rootScope, $scope, $filter, $modal, $i18next, $ngBootbox,
        ...
        $scope.phy_monitor_pdu_table = new ngTableParams({
                page: 1,
                count: 10
            },{
                counts: [],
                getData: function($defer, params){
                    Phy_Monitor_Pdu.query(function(data){
                        $scope.phy_monitor_pdus = ngTableHelper.paginate(data, $defer, params);
                        checkboxGroup.syncObjects($scope.phy_monitor_pdus);
                    });
                }
            });
