...
1.各个文件的说明
   ...
   phy_monitor_pdu_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   phy_monitor_pdu.html: 具体模版 
...
3.部署应用
   ...
   d.添加sidebar
        ...
        比如:
         ...
         <li>
            <a href="#/phy_monitor_pdu/">
                <i class="fa fa-users"></i>
                <span class="title">
                    {[{ 'sidebar.phy_monitor_pdu' | i18next }]}
                </span>
   ...
   j.add app in settings
      ...
      比如应用的名称是phy_monitor_pdu,则添加biz.phy_monitor_pdu
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh phy_monitor_pdu 
